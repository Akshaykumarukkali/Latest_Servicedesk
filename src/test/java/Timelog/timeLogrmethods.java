...
public class timeLogrmethods {
	...
	By exportButton = By.xpath(
			"//android.view.ViewGroup[@content-desc=', Export']/android.view.ViewGroup[2]/android.widget.TextView[1]");
	...
	By periodDropdownOptionyesterday = By
			.xpath("//android.view.ViewGroup[@content-desc='Yesterday']/android.widget.TextView");

	By periodDropdownOptionThisweek = By
			.xpath("//android.view.ViewGroup[@content-desc='This week']/android.widget.TextView");
	...
	By periodDropdownOptionThisyear = By
			.xpath("//android.view.ViewGroup[@content-desc='This year']/android.widget.TextView");

	By periodDropdownOptionLastweek = By
			.xpath("//android.view.ViewGroup[@content-desc='Last week']/android.widget.TextView");

	By periodDropdownOptionLastmonth = By
			.xpath("//android.view.ViewGroup[@content-desc='Last month']/android.widget.TextView");

	By periodDropdownOptionLastquarter = By
			.xpath("//android.view.ViewGroup[@content-desc='Last quarter']/android.widget.TextView");
	...
	By SelectDropdownOptionbillable = By
			.xpath("//android.view.ViewGroup[@content-desc='Billable']/android.widget.TextView");

	By SelectDropdownOptionnonbillable = By
			.xpath("//android.view.ViewGroup[@content-desc='Non - Billable']/android.widget.TextView");
