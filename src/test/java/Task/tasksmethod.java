...
public class tasksmethod {
	...
	By createtask = By.xpath(
			"//android.view.ViewGroup[@content-desc=', Create Task']/android.view.ViewGroup[2]/android.widget.TextView[2]");
	...
	By dateselect = By.xpath("//android.view.View[@index='23']");
	...
	By searchticketfield = By.xpath(
			"//android.view.ViewGroup[@content-desc='Create New Task']/android.widget.ScrollView/android.view.ViewGroup/android.view.ViewGroup[7]/android.view.ViewGroup");

	By radioself = By.xpath(
			"//android.view.ViewGroup[@content-desc=\" Create New Task\"]/android.widget.ScrollView/android.view.ViewGroup/android.view.ViewGroup[8]/android.view.ViewGroup[1]/android.widget.RadioButton/android.view.ViewGroup");

	By radioOther = By.xpath(
			"//android.view.ViewGroup[@content-desc=\" Create New Task\"]/android.widget.ScrollView/android.view.ViewGroup/android.view.ViewGroup[9]/android.view.ViewGroup[1]/android.widget.RadioButton/android.view.ViewGroup");

	By DescriptionField = By.xpath("//android.widget.EditText[@text='Description']");
	...
	By todaydropdown = By.xpath(
			"//android.view.ViewGroup[@content-desc='Today']/android.view.ViewGroup[1]/android.view.ViewGroup/android.view.View");
	...
	By periodoptionall = By.xpath("//android.widget.TextView[@text='All']");
	...
	By taskStatusNotstarted = By.xpath(
	...
	public void createTaskclick() {
		...
		wait.until(ExpectedConditions.visibilityOfElementLocated(createtask));
	...
	public void periodoptionallclick() throws InterruptedException {
		driver.findElement(periodoptionall).click();
	}

	public void dotsIconclick() {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(5));
		wait.until(ExpectedConditions.visibilityOfElementLocated(dotsIcon));
